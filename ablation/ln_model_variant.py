...
def create_noNorm_model(base_model):
    ...
    model.config.name_or_path = "shng2025/GPT-Valkyrie_LN-124m__noNorm__"
    return model
...
def create_AttnOnly_model(base_model):
    ...
    model.config.name_or_path = "shng2025/GPT-Valkyrie_LN-124m__AttnOnly__"
    return model
...
def create_FFNonly_model(base_model):
    ...
    model.config.name_or_path = "shng2025/GPT-Valkyrie_LN-124m__FFNonly__"
    return model
...
# Load the base model
base_model_path = "shng2025/GPT-Valkyrie_LN-124m__baseModel__"
