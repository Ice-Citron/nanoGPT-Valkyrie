...
# torchrun --standalone --nproc_per_node=4 LLMC_train_gpt2.py --write_tensors=0 --compile=1 --tensorcores=1 --dtype=bfloat16
...
if __name__ == "__main__":
    ...
    # file system input / output
            # REFER TO ORIGINAL CODE FOR THIS SECTION HERE'S CHANGESa
    ...
    parser.add_argument("--num_iterations", type=int, default=19073, help="number of iterations to run")
    parser.add_argument("--inference_only", type=int, default=1, help="only run inference")
    # optimization
    parser.add_argument("--learning_rate", type=float, default=6e-4, help="learning rate warmup iterations")
    parser.add_argument("--warmup_iters", type=int, default=715, help="learning rate warmup iterations")
    ...
    parser.add_argument("--val_max_steps", type=int, default=32, help="how many batches of val to average?")
    parser.add_argument("--sample_every", type=int, default=250, help="how often to sample from the model?") # this is just getting the model to generate?
    # debugging
