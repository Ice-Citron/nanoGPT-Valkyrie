...
dropout = 0.2
block_size = 256
vocab_size = 65  # This should match your actual vocab size

# Copy all your class definitions here: Head, MultiHeadAttention, FeedFoward, Block, and GPTLanguageModel
# Make sure to remove any device-specific code (like .to(device))
