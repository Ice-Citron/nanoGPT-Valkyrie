...
def create_model_variant(base_model, variant_type):
    ...
    model.config.name_or_path = f"shng2025/GPT-Valkyrie_RMSN-124m__{variant_type}__"
...
for variant in variants:
    ...
    save_path = f"GPT-Valkyrie_RMSN-124m__{variant}__"
...
for variant in variants:
    model_path = f"GPT-Valkyrie_RMSN-124m__{variant}__"
